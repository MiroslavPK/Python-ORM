...
def set_category_and_price(apps, schema_editor):
    set_smartphone_price(apps, schema_editor)
    set_smartphone_category(apps, schema_editor)


def revert_category_and_price(apps, schema_editor):
    smartphone_model = apps.get_model('main_app', 'Smartphone')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_category_and_price, reverse_code=revert_category_and_price)
    ]
