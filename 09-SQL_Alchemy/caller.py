...
engine = create_engine('postgresql+psycopg2://mirecyt:234@localhost/sql_alchemy')
...
# recipe1 = create_recipe("Chicken Stir-Fry", "Chicken, Bell Peppers, Soy Sauce, Vegetables", "Stir-fry chicken and vegetables with soy sauce")
# recipe1 = create_recipe("Caesar Salad", "Romaine Lettuce, Croutons, Caesar Dressing", "Toss lettuce with dressing and top with croutons")
...
def swap_recipe_ingredients_by_name(first_recipe_name: str, second_recipe_name: str):
    first_recipe = (
        ...
        .with_for_update()  # lock the record in db, so it can't be used elsewhere
        .one()
    )
