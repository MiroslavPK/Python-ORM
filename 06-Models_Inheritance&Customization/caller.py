...
from main_app.models import Mage, Necromancer, UserProfile, Message, Student, CreditCard, Hotel, Room, SpecialReservation, RegularReservation
...
hotel = Hotel.objects.create(name="Hotel BC", address="123 Main St")
...
regular_reservation1 = RegularReservation(
    room=room1,
    start_date=date(2023, 1, 1),
    end_date=date(2023, 1, 5)
)

print(regular_reservation1.save())
